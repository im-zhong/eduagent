...
class EduAgentAPIClient:
    ...
    def _make_request(self, endpoint: str, method: str = "GET", data: dict | None = None) -> dict[str, Any]:
    ...
    def upload_textbook(self, filename: str, subject: str, grade_level: str) -> dict[str, Any]:
    ...
    def generate_questions(self, knowledge_point_ids: list[str], question_type: str,
                          difficulty: str, num_questions: int) -> dict[str, Any]:
    ...
    def control_question_difficulty(self, question_text: str, target_difficulty: float) -> dict[str, Any]:
    ...
    def generate_distractors(self, question_text: str, knowledge_point_id: str) -> dict[str, Any]:
    ...
    def start_practice_session(self, knowledge_point_ids: list[str], num_questions: int,
    ...
    def get_performance_analytics(self, student_id: str, time_period: str) -> dict[str, Any]:
